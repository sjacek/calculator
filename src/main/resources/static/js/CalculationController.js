...
angular
    .module('calculatorApp', ['ngAnimate'])
    .controller('calculationController', function ($scope,$http) {
    ...
    function findAllCalculations() {
        ...
        $http.get(urlBase + '/calculations/search/findAll').
...
calculationModule.directive('ngConfirmClick', [
    function(){
        return {
